...
import LDRApp from "../../../assets/LDR.JPG";
...
const data_projects = [
  ...
  {
    imgsrc: LDRApp,
    title: "Heart Bridge App",
    text: "This app supports long-distance relationships with real-time messaging, notifications, and gamified interactions. It leverages bidirectional data fetching and RESTful APIs for a seamless experience between users.",
    // view: "https://github.com/AlinMican1/workoutApp",
    type: "React - NextJs - CapcitorJS - NodeJs - JavaScript - CSS - HTML - MongoDB - JEST - Socket.IO - AWS",
  },
];
